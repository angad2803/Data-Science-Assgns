...
| Model         | Avg Time (s) | ROUGE-L | BLEU  | TOPSIS Score |
| ------------- | ------------ | ------- | ----- | ------------ |
| Flan-T5-Base  | 0.081        | 0.512   | 0.401 | **0.823** ✓  |
...
@software{gpu_topsis_summarization,
  ...
  year = {2026},
  url = {https://github.com/angad2803/Data-Science-Assgns}
}
```
...
- **GitHub Issues:** [Report bugs](https://github.com/angad2803/Data-Science-Assgns/issues)
- **Email:** angad2803@example.com
