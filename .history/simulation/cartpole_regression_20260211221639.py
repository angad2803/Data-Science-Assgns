# STEP 1: Download OpenAI Gymnasium
# Run: pip install gymnasium[classic_control] -q
...
def run_episode():
    ...
    # We return the state reached just before/at termination and the total reward
...
for _ in range(NUM_EPISODES):
    ...
    data.append([
        final_state[0], # Cart Position
        final_state[1], # Cart Velocity
        final_state[2], # Pole Angle
        final_state[3], # Pole Angular Velocity
        episode_reward
    ])
...
# STEP 8: Visualization of Best Model
# Based on your previous run, Random Forest performed well
