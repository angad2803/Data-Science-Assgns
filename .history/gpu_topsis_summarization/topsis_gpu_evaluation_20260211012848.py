"""
GPU-Accelerated TOPSIS-Based Text Summarization Model Evaluation

This script evaluates pretrained T5/Flan-T5 models on GPU using TOPSIS ranking.
Optimized for Google Colab and systems with CUDA support.
