...
1. **Upload Dataset:** Upload `data.csv` to the `/content/` directory in Google Colab.

2. **Execute the Notebook:**
   - Open `ASSIGNMENT_4.ipynb` in Google Colab
   - Run all cells sequentially
   - The parameters (A, B) will be automatically calculated based on the hardcoded UID (102313005)
